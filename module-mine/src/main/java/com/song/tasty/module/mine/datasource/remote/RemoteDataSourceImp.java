...
import com.song.tasty.module.mine.datasource.remote.api.service.MineApiService;
...
public class RemoteDataSourceImp implements RemoteDataSource {
    ...
    @Override
    public Observable<MIneResult> login(String account, String password) {
        return RetrofitManager
                .init()
                .obtainRetrofitService(MineApiService.class)
