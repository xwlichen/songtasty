...
public class MineComponent implements IComponent {
    ...
    private void getHomeFragment(CC cc) {
        ...
        FlutterFragment fragment=FlutterFragment.withNewEngine().initialRoute(FRouterConstants.ROUTER_MINE_MIAN).build();
        fragment=FlutterPageUtils.getInstance().createFragment(context,FRouterConstants.ROUTER_MINE_MIAN);
