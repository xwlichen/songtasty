package com.song.tasty.common.core.cache;
...
public class LruCache<K, V> implements Cache<K, V> {
     ...
     *
     * @param size 这个缓存的最大 size,这个 size 所使用的单位必须和 {@link #getItemSize} 所使用的单位一致.
     */
     ...
     * 此时会回调 {@link #onItemEvicted} 通知此方法当前被驱逐的条目
     *
