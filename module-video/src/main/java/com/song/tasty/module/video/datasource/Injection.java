package com.song.tasty.module.video.datasource;
...
import com.song.tasty.module.video.datasource.remote.RemoteDataSource;
import com.song.tasty.module.video.datasource.remote.RemoteDataSourceImp;

import me.jessyan.retrofiturlmanager.RetrofitUrlManager;

import static com.song.tasty.module.video.Constants.VIDEO_DOMAIN_NAME;
import static com.song.tasty.module.video.Constants.VIDEO_HOST_ONLINE_URL;
...
public class Injection {
    ...
    public static DataRepository provideDataRepository() {
        ...
        RetrofitUrlManager.getInstance().putDomain(VIDEO_DOMAIN_NAME, VIDEO_HOST_ONLINE_URL);
