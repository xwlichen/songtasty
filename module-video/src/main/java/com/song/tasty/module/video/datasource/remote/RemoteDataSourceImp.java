...
import com.song.tasty.module.video.datasource.remote.api.service.VideoApiService;
...
public class RemoteDataSourceImp implements RemoteDataSource {
    ...
    @Override
    public Observable<VideoResult> login(String account, String password) {
        return RetrofitManager
                .init()
                .obtainRetrofitService(VideoApiService.class)
