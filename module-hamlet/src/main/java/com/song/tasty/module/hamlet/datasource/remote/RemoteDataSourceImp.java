...
import com.song.tasty.module.hamlet.datasource.remote.api.service.HamletApiService;
...
public class RemoteDataSourceImp implements RemoteDataSource {
    ...
    @Override
    public Observable<HamletResult> login(String account, String password) {
        return RetrofitManager
                .init()
                .obtainRetrofitService(HamletApiService.class)
