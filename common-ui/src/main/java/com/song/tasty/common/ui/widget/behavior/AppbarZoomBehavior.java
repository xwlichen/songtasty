...
public class AppbarZoomBehavior extends AppBarLayout.Behavior {
    ...
    private void init(AppBarLayout abl) {
        ...
        mImageView = (ImageView) abl.findViewById(R.id.ivheader);
        if (mImageView != null) {
    ...
    @Override
    public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout child, @NonNull View directTargetChild, @NonNull View target, int axes) {
        isAnimate = true;
        return super.onStartNestedScroll(coordinatorLayout, child, directTargetChild, target, axes);
    }

    @Override
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target, int dx, int dy, int dxUnconsumed, int dyUnconsumed, int type) {
//        super.onNestedScroll(coordinatorLayout, child, target, dx, dy dxUnconsumed, dyUnconsumed, type);
